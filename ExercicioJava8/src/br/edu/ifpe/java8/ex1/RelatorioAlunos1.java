...
public class RelatorioAlunos1 {
	...
	static {
		...
		PREDICADO.put(TipoRelatorio1.TODOS, aluno -> true);
		PREDICADO.put(TipoRelatorio1.APENAS_APROVADOS, aluno -> aluno.getMedia() >= MEDIA_APROVACAO);
		PREDICADO.put(TipoRelatorio1.APENAS_FINAL, aluno -> aluno.getMedia() < MEDIA_APROVACAO && aluno.getMedia() >= MEDIA_MINIMA_FINAL);
		PREDICADO.put(TipoRelatorio1.APENAS_REPROVADOS_DIRETO, aluno -> aluno.getMedia() < MEDIA_APROVACAO);
	}
