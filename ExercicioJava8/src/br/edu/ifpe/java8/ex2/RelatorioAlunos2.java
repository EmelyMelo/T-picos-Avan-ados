...
import br.edu.ifpe.java8.ex1.TipoRelatorio1;
 ...
 *		5 - Com a matrícula e a média de todos os alunos;
 *
...
public class RelatorioAlunos2 {
	...
	private static final Map <TipoRelatorio2, Function<Aluno, String>> FUNCAO;
	static {
		FUNCAO = new HashMap<>();
		FUNCAO.put(TipoRelatorio2.NOME, aluno -> aluno.getNome());
		FUNCAO.put(TipoRelatorio2.MATRICULA_MEDIA, aluno -> aluno.getMatricula() + SEPARADOR + aluno.getMedia());
		FUNCAO.put(TipoRelatorio2.NOME_MATRICULA, aluno -> aluno.getNome() + SEPARADOR + aluno.getMatricula());
		FUNCAO.put(TipoRelatorio2.NOME_MATRICULA_MEDIA, aluno -> aluno.getNome() + SEPARADOR + aluno.getMatricula() + SEPARADOR + aluno.getMedia());
		FUNCAO.put(TipoRelatorio2.NOME_MEDIA, aluno -> aluno.getNome() + SEPARADOR + aluno.getMedia());
	...
	public static void gerar(TipoRelatorio2 opcao) {
		...
		try {
			...
			while (leitor.hasNextLine()) {
				...
				escritor.println(FUNCAO.get(opcao).apply(aluno));
